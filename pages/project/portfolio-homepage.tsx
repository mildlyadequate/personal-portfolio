...
const personalPortfolio = () => {
    ...
    return (
        <>
            <Head>
                <title>{T.project_portfolio_page_title}</title>

                <meta property="og:image:width" content="1145" />
                <meta property="og:image:height" content="599" />
                <meta property="og:title" content={T.project_portfolio_page_title} />
            ...
            <Layout>
                ...
                <SchemaHandler
                    ...
                    url={T.page_url + T.project_portfolio_internal_link}
                    modified={"2022-03-10"}
