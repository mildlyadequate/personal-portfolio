...
const FormSuccessMessage = () => {
    ...
    return (
        <div className={`fixed top-16 left-1/2 right-1/2 -mx-40 z-10 ${showMessage ? "" : "hidden"} `}>
            <div className="bg-green-500 shadow-lg mx-auto w-80 max-w-full text-sm pointer-events-auto bg-clip-padding rounded-lg block mb-3">
                <div className="bg-green-500 flex justify-between items-center py-2 px-3 bg-clip-padding border-b border-green-400 rounded-t-lg">
                    ...
                    <div className="flex items-center cursor-pointer">
                        ...
                        <button type="button" className="cursor-pointer btn-close btn-close-white box-content w-4 h-4 ml-2 text-white border-none rounded-none opacity-50 focus:shadow-none focus:outline-none focus:opacity-100 hover:text-white hover:opacity-75 hover:no-underline" aria-label="Close">
